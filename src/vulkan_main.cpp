...
VkExtent2D select_swap_extent(
    SDL_Window *window, const VkSurfaceCapabilitiesKHR &capabilities);
...
Vulkan::Vulkan(SDL_Window *window) : window(window)
{
    create_instance();
    create_surface();
...
void Vulkan::wait_till_idle()
{
    vkDeviceWaitIdle(device);
}

void Vulkan::framebuffer_size_changed()
{
...
void Vulkan::allocate_command_buffers()
{
...
void Vulkan::record_command_buffer(
